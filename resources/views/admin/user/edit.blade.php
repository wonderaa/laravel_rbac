    ...
    <form class="layui-form" action="" style="width: 800px;">
        <div class="layui-form-item" style="width: 500px;">
            ...
            <div class="layui-input-block">
                <input type="text" name="realname" required lay-verify="required|realname" placeholder="请输入姓名"
        ...
        <div class="layui-form-item" style="width: 500px;">
            ...
            <div class="layui-input-block">
                <input type="text" name="username" required lay-verify="required|username" placeholder="用户名"
                       autocomplete="off" class="layui-input"
                       @if($user)
                       value="{{ $user->username }}"
                        @endif
            ...
            <div class="layui-input-block">
                @foreach($permission as $permission)
                    <input type="checkbox" name="permission[{{ $permission->id }}]" value="{{ $permission->id }}"
                           ...
                           @if($role_ids && in_array($permission->id,$role_ids))
                             checked
                            @endif
                    >
                @endforeach
